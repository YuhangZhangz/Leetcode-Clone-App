...
const Timer: React.FC<TimerProps> = () => {
    ...
    return (
        <div>
            {showTimer ? (
                <div className='flex items-center space-x-2 bg-gray-700 p-1.5 cursor-pointer rounded hover:bg-gray-600 text-white'>
                ...
                <div
                    className='flex items-center p-1 h-8 hover:bg-gray-700 rounded cursor-pointer text-white'
